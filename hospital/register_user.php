  ...
  <div class="container">
    ...
    <div class="content">
      <form method="post">
        ...
        <div class="input-box">
            <span class="details">Log In Type</span>
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your number" required name="phone_number">
          </div>
          <div class="input-box">
            <span class="details">Password</span>
            <input type="text" placeholder="Enter your password" required name="pwd">
</div>
        </div>
...
if(isset($_POST["submit"]))
 {
  ...
  $con=mysqli_connect('localhost','nikhil','','test'); 
    $qry="INSERT INTO register_user (`full_name`,`user_name`,`phone_number`,`email`,`pwd`,`log1`)
     VALUES ('$full_name','$user_name','$phone_number','$email','$pwd','$log1');";
